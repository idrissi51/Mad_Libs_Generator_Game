...
root.title("Mad_Libs_Generator_Game")
Label(root,
      text="Mad Libs Generator \n Have Fun!",
      fg="red",
      font="arial 20 bold").pack()
Label(root, text="Click Any one: ", fg="orange",
      font="arial 15 bold").place(x=5, y=70)
...
def madlib3():
    ...
    print(
        ...
        '. Then there was a ' + adjective + ' apple that looked like a ' +
...
Button(root,
       ...
       command=madlib1,
       font="arial 15",
       bg="#20bebe").place(x=70, y=120)
Button(root,
       text="apple and apple",
       command=madlib2,
       font="arial 15",
       bg="#20bebe").place(x=78, y=180)
Button(root,
       text="The Butterfly",
       command=madlib3,
       font="arial 15",
       bg="#20bebe").place(x=90, y=240)
